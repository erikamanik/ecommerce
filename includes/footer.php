...
<h3>Horas Mart</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> Horas Mart merupakan sebuah ecommerce yang menjadi platform untuk memesan barang-barang khas batak.</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">horas@batak.com</a></span>
                </div>
            </li>
